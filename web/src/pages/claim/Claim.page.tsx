...
function ClaimPage() {
  ...
  const { setConfirmed, setClaimDetails } = useLinkStore((state: any) => state);
        ...
        <div className={classes.formContainer}>
          ...
          <Button
            ...
            onClick={async () => {
              ...
              const safeAccount = await claimLink(
                queryParams.c,
                queryParams.i,
                queryParams.p,
                signer
              );
              setClaimDetails({ address: safeAccount.address, amount: linkDetails.amount})
